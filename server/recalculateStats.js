...
export async function recalculateAllStats() {
  ...
  for (const game of games) {
    ...
    p1.elo = Number((p1.elo + team1Change).toFixed(2));
    p2.elo = Number((p2.elo + team1Change).toFixed(2));
    p3.elo = Number((p3.elo + team2Change).toFixed(2));
    p4.elo = Number((p4.elo + team2Change).toFixed(2));
  }
